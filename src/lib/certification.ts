  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        practice: [ex("claude-code/claude-md"), ex("config/allow-rule"), ch("config-guardrails")],
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        practice: [ex("claude-api/tokens"), ex("claude-code/context")],
      },
      {
      ...
      },
      {
        ...
        practice: [ex("claude-api/tokens"), ex("agent-sdk/spending-cap")],
      },
      {
        name: "Cost and Token Management",
        weight: 2.8,
        summary: "Tracking token usage, modeling cost, and prompt caching.",
        practice: [ex("agent-sdk/spending-cap"), ch("api-caching"), ch("api-batch")],
      },
    ],
  },
  {
