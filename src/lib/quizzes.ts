  ...
  apps: [
    ...
    },
    {
      ...
      options: [
        ...
        "Claude deletes personal details such as names between requests unless retention is enabled",
        "The system prompt needs a memory setting so Claude keeps facts from one request to the next",
      ],
      answer: [0],
    ...
    },
    {
      ...
      options: [
        ...
        "Leave the model field out so the API always picks a sensible default for each request",
        "Hard-code the model ID separately in every file that calls Claude, so each is explicit",
      ],
      answer: [0],
      explain:
  ...
  eval: [
    ...
    },
    {
      ...
      options: [
        ...
        "Retry the same request in a loop until the output happens to parse",
  ...
  security: [
    ...
    },
    {
      ...
      options: [
        ...
        "Claude Code runs the hook again until it exits with code 0",
