...
A local playground for experimenting with **Claude Code**, the **Claude Agent SDK**, the **Claude API** and **MCP**.
Type a prompt, change the tools, permissions and MCP servers, and watch every tool call, permission prompt and message appear as it happens.
...
Then open **http://localhost:3000**. Pick an example on the left, or write your own prompt.
...
| An example behaves strangely after lots of runs | Click **Reset workspace** at the bottom of the page. |
